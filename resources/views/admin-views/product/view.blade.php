            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <span>Price :
                            <span>{{\App\CPU\Convert::default($product['unit_price'])}} {{\App\CPU\currency_symbol()}}
                            </span>
                        </span><br>
                        <span>TAX :
                        ...
                        <span>Discount :
                            <span> {{ $product->discount_type=='flat'?(\App\CPU\Convert::default($product->discount).''.\App\CPU\currency_symbol()): $product->discount.''.'%'}} </span>
                        </span><br>
                        <span>Current Stock :
