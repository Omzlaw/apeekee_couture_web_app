        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{trans('messages.Settings')}}</h1>
                </div>
        ...
        <div class="row">
                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:" id="generalSection">
                                    <i class="tio-user-outlined nav-icon"></i>{{trans('messages.Basic')}} {{trans('messages.information')}}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:" id="passwordSection">
                                    <i class="tio-lock-outlined nav-icon"></i> {{trans('messages.Password')}}
                                </a>
                            </li>
                        </ul>
                        <!-- End Navbar Nav -->
            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header">
                            <h2 class="card-title h4">{{trans('messages.Basic')}} {{trans('messages.information')}}</h2>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">{{trans('messages.Full')}} {{trans('messages.name')}}  <i
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="phoneLabel" class="col-sm-3 col-form-label input-label">{{trans('messages.Phone')}} <span
                            ...
                            <div class="row form-group">
                                <label for="newEmailLabel" class="col-sm-3 col-form-label input-label">{{trans('messages.Email')}}</label>
                            ...
                            <div class="col-md-3 col-form-label">
                                ...
                                <div class="form-group col-md-9" id="select-img">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="customFileUpload">{{trans('messages.image')}} {{trans('messages.Upload')}}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('admin-profile-form','Want to update admin info ?')":"call_demo()"}}" class="btn btn-primary">Save changes</button>
                            </div>
                            <!-- End Form -->
                        </div>
                        <!-- End Body -->
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h4 class="card-title">{{trans('messages.Change')}} {{trans('messages.your')}} {{trans('messages.password')}}</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            <div class="row form-group">
                                <label for="newPassword" class="col-sm-3 col-form-label input-label"> {{trans('messages.New')}}
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label input-label"> {{trans('messages.Confirm')}}
                                    {{trans('messages.password')}} </label>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm','Want to update admin password ?')":"call_demo()"}}" class="btn btn-primary">{{trans('messages.Save')}} {{trans('messages.changes')}}</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
