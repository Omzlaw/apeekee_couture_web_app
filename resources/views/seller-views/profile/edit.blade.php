                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9 row">
                                    <div class="col-md-6">
                                        <label for="name">First {{trans('messages.Name')}}  <span class="text-danger">*</span></label>
                                        <input type="text" name="f_name" value="{{$data->f_name}}" class="form-control" id="name"
                                               required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="name">{{trans('messages.Last')}} {{trans('messages.Name')}}  <span class="text-danger">*</span></label>
